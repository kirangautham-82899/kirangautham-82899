...
Computer Science engineer — B.Tech, CGPA 8.18, Class of 2026 — currently a **Software Engineer at Sustains.ai Financial Solutions LLP**, Bangalore. Internship converted to full-time. Work spans production full-stack platforms, AI/ML research, cybersecurity tooling, and real-time systems.

```typescript
const kiran = {
  role     : "Software Engineer @ Sustains.ai Financial Solutions LLP",
  education: "B.Tech Computer Science  —  CGPA 8.18  |  2026",
  location : "Palakkad, Kerala, India",
  domains  : ["Full Stack Engineering", "AI/ML & Explainability", "Cybersecurity", "Real-Time Systems"],
  research : "Explainable Vehicle Trajectory Prediction  —  CNN-LSTM + Grad-CAM",
  awards   : "15+ hackathon wins and national recognitions",
  open_to  : "Full Stack · AI/ML · Cybersecurity · Real-Time Engineering",
};
```
...
| Achievement | Detail |
|:---|:---|
| 15+ hackathon wins and recognitions | National and state-level competitions across multiple domains |
| Research publication | Computer Vision and Autonomous Systems — CNN-LSTM + Grad-CAM |
